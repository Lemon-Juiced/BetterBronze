...
public class BetterBronzeTiers {
    /**
    ...
    public static final Tier BRONZE_TIER = TierSortingRegistry.registerTier(new SimpleTier(2, 191, 5.0F, 1.5F, 9, BetterBronzeTags.Blocks.NEEDS_BRONZE_TOOL, () -> Ingredient.of(BetterBronzeTags.Items.INGOTS_BRONZE)), new ResourceLocation(BetterBronze.MOD_ID, "bronze"), List.of(Tiers.STONE), List.of(Tiers.IRON));
    public static final Tier BRONZE_HOE_TIER = TierSortingRegistry.registerTier(new SimpleTier(2, 191, 5.0F, 2.0F, 9, BetterBronzeTags.Blocks.NEEDS_BRONZE_TOOL, () -> Ingredient.of(BetterBronzeTags.Items.INGOTS_BRONZE)), new ResourceLocation(BetterBronze.MOD_ID, "bronze_hoe"), List.of(Tiers.STONE), List.of(Tiers.IRON));
}
