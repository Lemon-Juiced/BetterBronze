...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> TIN_ORE = registerBlock("tin_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.m_284310_().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    ...
    public static final RegistryObject<Block> RAW_TIN_BLOCK = registerBlock("raw_tin_block", () -> new Block(BlockBehaviour.Properties.m_284310_().requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
